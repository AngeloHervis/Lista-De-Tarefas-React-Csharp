...
app.MapGet("/api/usuarios/listar", (AppDbContext context) =>
{
...
app.MapPost("/api/usuarios/cadastrar", (AppDbContext context, Usuario usuario) =>
{
...
app.MapPut("/api/usuarios/alterar/{id}", (AppDbContext context, int id, Usuario usuario) =>
{
...
app.MapDelete("/api/usuarios/excluir/{id}", (AppDbContext context, int id) =>
{
...
app.MapGet("/api/tarefas/listar", (AppDbContext context) =>
{
...
app.MapPost("/api/tarefas/cadastrar", (AppDbContext context, Tarefa tarefa) =>
{
...
app.MapPut("/api/tarefas/alterar/{id}", (AppDbContext context, string id, Tarefa tarefa) =>
{
...
app.MapDelete("/api/tarefas/excluir/{id}", (AppDbContext context, string id) =>
{
...
app.MapGet("/api/categorias/listar", (AppDbContext context) =>
{
...
app.MapPost("/api/categorias/cadastrar", (AppDbContext context, Categoria categoria) =>
{
...
app.MapPut("/api/categorias/alterar/{id}", (AppDbContext context, string id, Categoria categoria) =>
{
...
app.MapDelete("/api/categorias/excluir/{id}", (AppDbContext context, string id) =>
{
...
app.MapGet("/api/tarefas/{tarefaId}/subtarefas/listar", (AppDbContext context, string tarefaId) =>
{
...
app.MapPost("/api/tarefas/{tarefaId}/subtarefas/cadastrar", (AppDbContext context, string tarefaId, SubTarefa subTarefa) =>
{
    var tarefa = context.Tarefas.Find(tarefaId);
    if (tarefa == null)
    {
    ...
    context.SaveChanges();
    return Results.Created($"/api/tarefas/{tarefaId}/subtarefas/obter/{subTarefa.SubTarefaId}", subTarefa);
});

//PUT: https://localhost:5272/api/tarefas/{tarefaId}/subtarefas/alterar/{id}
app.MapPut("/api/tarefas/{tarefaId}/subtarefas/alterar/{id}", (AppDbContext context, string tarefaId, string id, SubTarefa subTarefa) =>
{
...
app.MapDelete("/api/tarefas/{tarefaId}/subtarefas/excluir/{id}", (AppDbContext context, string tarefaId, string id) =>
{
